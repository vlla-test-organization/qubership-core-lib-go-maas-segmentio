module github.com/vlla-test-organization/qubership-core-lib-go-maas-segmentio/v3
...
require (
	...
	github.com/vlla-test-organization/qubership-core-lib-go/v3 v3.0.33 // indirect
